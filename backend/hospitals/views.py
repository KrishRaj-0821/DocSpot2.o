...
class HospitalProfileViewSet(viewsets.ModelViewSet):
    queryset = HospitalProfile.objects.prefetch_related('hospital_departments__department', 'facilities').all() # Optimized: Added prefetch_related to prevent N+1 queries
