...
export const About = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900 transition-colors duration-250">
      <SEO 
        title="About Us" 
        description="Learn about DocSpot's mission, values, our premium facilities, and our dedication to providing accessible healthcare in Seemanchal." 
      />
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <p className="text-sm text-slate-550 dark:text-slate-400 leading-relaxed">
          DocSpot is a patient-centric, unified digital healthcare ecosystem built specifically to bridge the clinical accessibility gap in Purnia, Katihar, Araria, and Kishanganj.
        </p>
      </div>
      ...
      <div className="mt-20 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-4 text-xs sm:text-sm text-slate-550 dark:text-slate-400 leading-relaxed">
            DocSpot was founded to solve a critical issue: patients traveling hours from surrounding towns to Line Bazar only to find that doctors were unavailable, clinics were full, or diagnostic scans were priced unpredictably.
            <br /><br />
        ...
        <div className="rounded-3xl bg-primary-950 p-10 text-white relative overflow-hidden shadow-xl text-center space-y-6">
          ...
          <h3 className="text-lg font-bold">DocSpot Numbers</h3>
